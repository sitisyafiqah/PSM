                    ...
                    <div class="panel-body">
                        <form role="form" action="" method="post">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Phone Number" name="user_phone" type="text" minlength="10" maxlength="11" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Address" name="user_address" type="text" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Password" name="user_password" type="password" value="" minlength="8" maxlength="12" required>
                                </div>
